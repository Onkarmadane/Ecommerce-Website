...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    <a href="../index.php" class="nav_link"> <i class='fa fa-home nav_icon'></i> <span class="nav_name">Home</span> </a>
    ...
    <div class="height-100">
        <div class="col-md-10 mt-5" style="margin-top:90px !important;">
                ...
                if (!isset($_GET['my_orders'])) {
                    if (!isset($_GET['delete_account'])) {
                        ...
                        if ($row_count_query > 0) {
                            echo "
                            <h2 class='text-center mt-5 mb-0' style='color:#277A89;'><b>You have <span class='text-danger'>$row_count_query</span> pending orders</b></h2>
                         </div>";
                        }
                    }
                }
                    ...
                    if (!isset($_GET['edit_account']) && !isset($_GET['my_orders']) && !isset($_GET['delete_account'])) {
                        ...
                        while ($row_orders = mysqli_fetch_assoc($resultOrders)) {
                            ...
                            if ($result_order_query) {
                                ...
                                if ($row_count_query == 0) {
                                    echo "<h2 class='text-center' style='color:#277A89;'>You have <span class='text-danger'>$row_count_query</span> pending orders</h2>
                            <p class='text-center'><a href='../index.php' class='text-dark fw-bold'>Explore Products</a></p>";
                                ...
                                // <p class='text-center'><a href='profile.php?my_orders?$orderId' class='text-dark fw-bold'>Order Details</a></p>";
                                //     }
                            } else {
