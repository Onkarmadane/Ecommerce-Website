      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mb-2 mb-lg-0 ms-auto mx-5">
            ...
            <li class="nav-item">
              <a class="btn position-relative "> <i class="fa fa-shopping-cart mx-1"></i>Cart
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger mx-1 " >1+</span>
              </a>
            </li>
            <li class="nav-item">
            <a class="nav-link mx-1" href="#"> <i class="fa fa-shopping-bag icon"></i> Become a Seller</a>
          </li>
          </ul>
        </div>
      </div>
