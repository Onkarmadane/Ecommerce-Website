            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-weight: 500;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./user_area/payment.php">Total Price: <?php total_price(); ?>/-</a>
                        </li>
                    </ul>
                        <form class="d-flex" role="search" action="search_products.php" method="get">
                            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="search">
                            <!-- <button class="btn btn-outline-light" type="submit">Search</button> -->
                            <input type="submit" value="Search" class="bg-success border-light text-light p-2" style="border-radius:10%; width:100px;" name="search_data">
                        </form>
                </div>
            </div>
        </nav>
    ...
    <div class="row">
        ...
        <!-- <div class="col-md-2 bg-secondary p-0">
            <ul class="navbar-nav me-auto pb-4 text-center">
                <li class="navbar-item bg-info pb-4" style="list-style:none; height: 40px; margin-bottom:auto;">
